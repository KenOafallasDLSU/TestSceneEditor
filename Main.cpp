...
int main()
{
	...
	ElementArrayBuffer lightEAB(lightIndices, sizeof(lightIndices));

	lightVA.linkAttrib(lightVB, 0, 3, GL_FLOAT, 3 * sizeof(float), (void*)0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		camera.initMatrix(lightShader, "camMatrix");
